...
void main() {
  ...
  group('Sync Logic Tests', () {
    ...
    test('Easy: Door Model Alias Integrity', () {
      final door = Door(
        id: 1, pos: 1, doorAlias: 'KUNDE-ADRESSE-T01', doorNumber: 'T01',
        floor: 'EG', roomNumber: '1', roomDesignation: 'Flur', doorType: 'T30',
        wingCount: 1, material: 'Stahl', manufacturer: 'Dorma', dinConfiguration: 'DIN L',
        closerType: 'TS93', closingSequenceSystem: 'None', lockDimensions: '72/8',
        closerOnHingeSide: true, closerOnOppositeSide: false, lintelHeightUnder1m: false,
        escapeDoorControl: false, accessControl: 'None', escapeRouteSituation: true,
        escapeRouteSignage: true, blindCylinder: false, pzCylinder: true,
        fittingType: 'Drücker', panicFunction: 'E', escapeDirectionRespected: true,
        fullPanicStandWing: false, doorFunctionOK: true,
      );
