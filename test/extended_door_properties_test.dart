...
void main() {
  ...
  group('Extended Door Properties Tests', () {
    test('Door model defaults and serialization for new properties', () {
      ...
      expect(door.lintelHeightOutsideOver1m, false);
      expect(door.lintelHeightInsideValue, isNull);
      expect(door.lintelHeightOutsideValue, isNull);
      ...
      expect(map['lintelHeightOutsideOver1m'], 0);
      expect(map['lintelHeightInsideValue'], isNull);
      expect(map['lintelHeightOutsideValue'], isNull);
      ...
      expect(restored.lintelHeightOutsideOver1m, false);
      expect(restored.lintelHeightInsideValue, isNull);
      expect(restored.lintelHeightOutsideValue, isNull);
      ...
      final updated = door.copyWith(
        ...
        dopNumber: 'DoP-12345',
        lintelHeightInsideOver1m: true,
        lintelHeightInsideValue: '2m',
        lintelHeightOutsideOver1m: true,
        lintelHeightOutsideValue: '3m',
        manufactureYear: '2022',
        fsaDriveAcceptanceDate: '2026-05-15',
      );

      expect(updated.approvalNumber, 'Z-6.5-2134');
      expect(updated.manufacturerNumber, 'HERST-9988');
      expect(updated.dopNumber, 'DoP-12345');
      expect(updated.lintelHeightInsideOver1m, true);
      expect(updated.lintelHeightInsideValue, '2m');
      expect(updated.lintelHeightOutsideOver1m, true);
      expect(updated.lintelHeightOutsideValue, '3m');
      expect(updated.manufactureYear, '2022');
      expect(updated.fsaDriveAcceptanceDate, '2026-05-15');
    });
